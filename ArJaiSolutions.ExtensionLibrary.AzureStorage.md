...
```csharp
public class ArJaiSolutions.ExtensionLibrary.AzureStorage.AzureBlobStorageActions
...
| Type | Name | Summary | 
| --- | --- | --- | 
| `CloudBlobClient` | BlobClient | Cloud Blob Client, from the Storage Account set `ArJaiSolutions.ExtensionLibrary.AzureStorage.AzureBlobStorageActions.StorageAccount`  This can be only set from the constructor of the Implementation of this Inteface | 
